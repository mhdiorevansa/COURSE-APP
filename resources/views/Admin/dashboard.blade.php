			...
			<div class="container-xl">
				...
				<div class="app-card alert alert-dismissible shadow-sm mb-4 border-left-decoration" role="alert">
					<div class="inner">
						<div class="app-card-body p-3 p-lg-4">
							<h3 class="mb-3">Selamat datang, {{ Auth::user()->role->role_name }}</h3>
							<div class="row gx-5 gy-3">
								<div class="col-12 col-lg-9">

									<div>DI halaman admin terdapat beberapa fitur yang dapat megelola data aplikasi</div>
								</div><!--//col-->
				...
				<div class="row g-4 mb-4">
					...
					<div class="col-6 col-lg-3">
						<div class="app-card app-card-stat shadow-sm h-90">
							<div class="app-card-body p-3 p-lg-4">
								<h4 class="stats-type mb-1">Total Kelas</h4>
								<div class="stats-figure">{{ $kelas_count }}</div>
							</div><!--//app-card-body-->
							<a class="app-card-link-mask" href="#"></a>
						</div><!--//app-card-->
					</div><!--//col-->
					<div class="col-6 col-lg-3">
						<div class="app-card app-card-stat shadow-sm h-90">
							<div class="app-card-body p-3 p-lg-4">
								<h4 class="stats-type mb-1">Total Materi</h4>
								<div class="stats-figure">{{ $materi_count }}</div>
							</div><!--//app-card-body-->
							<a class="app-card-link-mask" href="#"></a>
						</div><!--//app-card-->
					</div><!--//col-->
					<div class="col-6 col-lg-3">
						<div class="app-card app-card-stat shadow-sm h-100">
							<div class="app-card-body p-3 p-lg-4">
								<h4 class="stats-type mb-1">Total Quiz</h4>
								<div class="stats-figure">{{ $quiz_count }}</div>
							</div><!--//app-card-body-->
							<a class="app-card-link-mask" href="#"></a>
						</div><!--//app-card-->
					</div><!--//col-->
								...
								<div class="item p-3">
									<div class="row align-items-center">
										<div class="col">
											...
											<div class="progress">
												<div class="progress-bar bg-success" role="progressbar" style="width: 34%;" aria-valuenow="84"
													aria-valuemin="0" aria-valuemax="100"></div>
											</div>
										</div><!--//col-->
										<div class="col-auto">
