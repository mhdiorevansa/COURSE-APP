...
<head>
	...
	<!-- App CSS -->
  @vite([ "resources/css/portal.css","resources/css/responsive-admin.css","resources/js/app.js", "resources/js/index-charts.js",
  "resources/js/chart.min.js","node_modules/@ckeditor/ckeditor5-build-classic/build/ckeditor.js"])
			...
			<div class="container-fluid py-2">
				<div class="app-header-content">
					<div class="row justify-content-between align-items-center">
						...
						<div class="app-utilities col-auto me-lg-3 me-1">
							

							<div class="app-utility-item app-user-dropdown dropdown">
								<a class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button"
									aria-expanded="false"><img src="{{ asset('storage/image/profil_user/default_pp.png') }}" alt="user profile"></a>
		...
		<div id="app-sidepanel" class="app-sidepanel">
			...
			<div class="sidepanel-inner d-flex flex-column">
				...
				<div class="app-branding">
					<a class="app-logo" href="index.html"><img class="logo-icon me-2" src="{{ asset('storage/image/profil_user/default_pp.png') }}"
				...
				<nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
					<ul class="app-menu list-unstyled accordion" id="menu-accordion">
						...
						<li class="nav-item has-submenu">
							...
							<div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
								<ul class="submenu-list list-unstyled">
									<li class="submenu-item"><a class="submenu-link" href="/all-kelas">Semua Kelas</a></li>
									<li class="submenu-item"><a class="submenu-link" href="/control-kelas">Control Kelas</a></li>
								</ul>
							</div>
						</li><!--//nav-item-->
						<li class="nav-item has-submenu">
							...
							<div id="submenu-2" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
								<ul class="submenu-list list-unstyled">
									<li class="submenu-item"><a class="submenu-link" href="/all-materi">Semua Materi</a></li>
									<li class="submenu-item"><a class="submenu-link" href="/control-materi">Control Materi</a></li>
								</ul>
							</div>
						</li><!--//nav-item-->
						<li class="nav-item">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
							<a class="nav-link" href="/control-quiz">
								<span class="nav-icon">
						...
						<li class="nav-item">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
							<a class="nav-link" href="/control-feedback">
								<span class="nav-icon">
						...
						<li class="nav-item">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
							<a class="nav-link" href="/control-forum">
								<span class="nav-icon">
